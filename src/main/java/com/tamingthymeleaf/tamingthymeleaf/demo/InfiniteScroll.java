...
/**
 * This demonstration uses HTML generated here (in the controller!) instead of
 * just the HTML coming from Thymeleaf templates.
 * <p>
 * This is really intended to be a very primitive transitional demonstration,
 * showing the basics of how HTMX could serve as the starting point for a more
 * component-oriented approach, or perhaps even used in combination with
 * WebSockets and Server-Side Events. https://htmx.org/docs/#websockets-and-sse
 * <p>
 * Put another way - this is a pretty messy, hacky mess... but it's also the
 * kernel for starting what could be a different approach.
 */
@Controller
...
public class InfiniteScroll {
	...
	public String nextPage(@PathVariable Integer id) {
		...
		// This is just to simulate a slow[er] server response, causing the HTMX wait
